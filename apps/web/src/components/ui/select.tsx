 ...
 *
 * A native select paints its own popup, and the popup takes its fill from the
 * control: `bg-card` is 4% white, so every dropdown on the ink surface came
 * out see-through with the page showing between the options. There is no
 * styling fix for that. The list is markup here instead, over `bg-popover`.
 *
