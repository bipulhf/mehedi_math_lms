        ...
        <div className="max-w-4xl mx-auto">
                ...
                >
                      ...
                      className={cn(
                        ...
                        isActive
                          ...
                          : isCompleted
                            ...
                            : "bg-surface-container-highest/50 text-on-surface/30"
                      )}
                    >
                      {isCompleted ? (
                  ...
                  {index < editorSteps.length - 1 && (
                    <div className="mx-4 sm:mx-8 w-8 sm:w-16 h-px bg-outline-variant/20 relative">
                      <div
                        className={cn(
                          "absolute inset-y-0 left-0 bg-primary transition-all duration-700",
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-bold font-mono text-primary text-right min-w-[3ch]">
        ...
        <div className="p-6 sm:p-12 flex-1 max-w-5xl mx-auto w-full">
          <div className="mb-10 text-center sm:text-left">
            ...
            <p className="text-sm text-on-surface/40 font-medium italic">
              All fields marked with <Required /> are required for curatorial clearance.
            </p>
          </div>
                ...
                <div className="md:col-span-2">
                  <label className="flex items-start gap-4 p-6 rounded-3xl border border-outline-variant/20 bg-primary/5 hover:bg-primary/10 transition-all cursor-pointer group">
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-sm font-bold text-on-surface">Exam Only Course</span>
                  ...
                  {teachers.map((teacher) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {teacher.bio && (
                          <p className="text-xs leading-relaxed text-on-surface/60 line-clamp-2">
                            {teacher.bio}
                          </p>
                        )}
                      </button>
              ...
              <FadeIn className="grid gap-8 lg:grid-cols-2 items-start">
                  ...
                  <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-4xl p-6 sm:p-8 relative overflow-hidden shadow-2xl">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-2 gap-8">
                        <section>
                          <h6 className="text-[0.6rem] uppercase font-bold tracking-[0.2em] text-on-surface/40 mb-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedTeachers.length > 0 ? (
                            ...
                            <span className="text-xs text-red-500 font-bold flex items-center gap-1.5">
                              <AlertCircle className="size-3.5" /> No instructors assigned
                            </span>
                          )}
                        </div>
                      </section>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-surface-container-lowest border border-dashed border-outline-variant/40 rounded-3xl p-6">
                    ...
                    <p className="text-xs text-on-surface/50 font-medium italic leading-relaxed">
