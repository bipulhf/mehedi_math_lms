    ...
    <div className="grid grid-cols-1 gap-6 xl:grid-cols-[24rem_minmax(0,1fr)] h-[calc(100vh-8rem)]">
      <div className="bg-card/80 border border-hairline/40 relative flex flex-col overflow-hidden">
        <div className="p-6 sm:p-8 space-y-6 shrink-0 border-b border-hairline/20">
          <div className="flex items-start justify-between gap-3">
            <div>
              <Skeleton className="h-8 w-24 mb-2 bg-chip-active" />
              <Skeleton className="h-3 w-48 bg-chip-active" />
            </div>
          </div>
          <Skeleton className="h-12 w-full bg-chip-active" />
          <div className="space-y-3 bg-panel-warm/40 border border-hairline/20 p-4">
            <Skeleton className="h-3 w-20 mb-2 bg-chip-active" />
      ...
      <div className="bg-card/80 border border-hairline/40 relative flex flex-col overflow-hidden">
        <div className="p-8 sm:p-12 space-y-4 border-b border-hairline/20 shrink-0 bg-card/50">
          ...
          <Skeleton className="h-4 w-48 bg-chip-active" />
        </div>
        <div className="flex-1 flex flex-col p-6 sm:p-12 items-center justify-center">
          <Skeleton className="w-[80%] max-w-lg h-64 bg-chip-active" />
        </div>
      </div>
    </div>
  );
