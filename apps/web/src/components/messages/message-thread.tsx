  ...
  return (
    <>
      <div className="p-8 sm:p-12 space-y-4 border-b border-outline-variant/20 shrink-0 bg-surface-container-lowest/50">
        <h3 className="font-body text-2xl font-medium text-on-surface">
      ...
      <div className="flex-1 flex flex-col p-6 sm:p-12 items-center justify-center">
        <div className="flex flex-col items-center justify-center bg-surface-container-low/30 border border-outline-variant/10 p-12 text-center max-w-lg w-full">
          <div className="w-20 h-20 rounded-full bg-surface-container-highest flex items-center justify-center mb-6 border border-outline-variant/20 text-on-surface/60">
            <MessageSquareText className="size-8" />
          </div>
          <h4 className="font-body text-xl font-bold text-on-surface">
...
export function MessageThread({
  ...
  return (
    <div className="bg-surface-container-lowest/80 border border-outline-variant/40 relative flex flex-col overflow-hidden">
      {thread ? (
        <>
          <div className="p-6 sm:px-8 space-y-4 border-b border-outline-variant/20 shrink-0 bg-surface-container-lowest/50 z-10">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="space-y-2">
                <div className="flex items-center gap-4">
                  <div className="flex size-14 items-center justify-center rounded-full bg-linear-to-br from-primary/20 to-primary/5 border border-primary/20 text-sm font-body font-bold text-primary">
              ...
              <div className="flex w-full items-center gap-3 md:max-w-md">
                <Input
                  ...
                  className="h-11 bg-surface-container-low/50 border-outline-variant/30"
                />
                <Button
                  type="button"
                  variant="outline"
          ...
          <div className="flex-1 flex flex-col p-6 sm:px-8 overflow-hidden">
            ...
            <div
              ...
              className="flex-1 flex flex-col gap-4 overflow-y-auto bg-surface-container-low/30 border border-outline-variant/10 p-6 scroll-smooth"
            >
              {isLoadingThread ? (
            ...
            <div className="bg-surface-container-low/50 border border-outline-variant/20 p-4 mt-6 shrink-0">
              <Textarea
                placeholder="Write a message..."
                className="min-h-24 bg-surface border-transparent focus-visible:ring-0 resize-none text-base p-4"
                value={composerValue}
