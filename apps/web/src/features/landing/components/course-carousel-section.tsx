...
function CarouselButton({
  ...
  return (
    <button
      ...
      className="flex size-11 items-center justify-center rounded-full border border-paper/40 bg-black/30 text-paper backdrop-blur-sm transition-colors hover:bg-paper hover:text-action-foreground"
      onClick={onClick}
      type="button"
    >
      <span
