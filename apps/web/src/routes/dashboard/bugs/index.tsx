      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-card/80 p-8 border border-hairline/40 relative overflow-hidden">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {bugs.length > 0 ? (
          bugs.map((bug) => (
            <div key={bug.id} className="bg-card/80 border border-hairline/40 p-8 relative overflow-hidden group transition-all hover:border-ink/20">
          ...
          <div className="bg-card/80 p-12 border border-hairline/40 text-center italic text-muted font-light">{t("bugs.mineEmpty")}</div>
        )}
      </div>
    </div>
  );
